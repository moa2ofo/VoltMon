...
int main(void)
{
  UnityBegin("test_should_return_0_set_INIT_and_clear_flags_when_cfg_is_valid.c");
  run_test(testVariablesAsset, "testVariablesAsset", 16);
  run_test(testVariableReset, "testVariableReset", 25);
  run_test(test_VoltMon_Init_u8_should_return_0_set_INIT_and_clear_flags_when_cfg_is_valid, "test_VoltMon_Init_u8_should_return_0_set_INIT_and_clear_flags_when_cfg_is_valid", 46);
