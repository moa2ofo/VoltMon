# 0 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_init_clears_preexisting_voltage/mock_VoltMon_cfg.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_init_clears_preexisting_voltage/mock_VoltMon_cfg.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/VoltMon_cfg.h" 1
# 7 "utExecutionAndResults/utUnderTest/build/test/mocks/test_init_clears_preexisting_voltage/mock_VoltMon_cfg.h" 2
...
# 50 "utExecutionAndResults/utUnderTest/build/test/mocks/test_init_clears_preexisting_voltage/mock_VoltMon_cfg.h"
#pragma GCC diagnostic pop
# 3 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c" 2
...
static const VoltMon_cfg_s *callback_VoltMon_CfgGet_pcfg_ReturnNull(int call_count) {
  return 
# 10 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c" 3 4
        ((void *)0)
# 10 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c"
            ;
}
...
# 34 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c" 3 4
                       0
# 34 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c"
                            );
  VoltMon_SetOvActive_b(
# 35 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c" 3 4
                       0
# 35 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c"
                            );
}
...
# 48 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c" 3 4
 ((void *)0)
# 48 "utExecutionAndResults/utUnderTest/test/test_init_clears_preexisting_voltage.c"
