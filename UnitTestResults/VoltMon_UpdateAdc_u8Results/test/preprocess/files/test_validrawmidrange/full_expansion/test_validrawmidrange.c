# 0 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 2
# 1 "utExecutionAndResults/utUnderTest/src/VoltMon_cfg.h" 1
# 4 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 2
# 1 "utExecutionAndResults/utUnderTest/src/VoltMon_priv.h" 1
# 5 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_validrawmidrange/mock_VoltMon_cfg.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_validrawmidrange/mock_VoltMon_cfg.h" 2
...
# 50 "utExecutionAndResults/utUnderTest/build/test/mocks/test_validrawmidrange/mock_VoltMon_cfg.h"
#pragma GCC diagnostic pop
# 6 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_validrawmidrange/mock_VoltMon_priv.h" 1
# 11 "utExecutionAndResults/utUnderTest/build/test/mocks/test_validrawmidrange/mock_VoltMon_priv.h"
#pragma GCC diagnostic push
...
#pragma GCC diagnostic pop
# 7 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 2
# 15 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
static const VoltMoncfgs *callbackcfgptr = 
# 15 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 3 4
                                          ((void *)0)
# 15 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
                                              ;
...
void setUp(void) {
  ...
  VoltMonSetUvActiveb(
# 39 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 3 4
                     0
# 39 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
                          );
  VoltMonSetOvActiveb(
# 40 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 3 4
                     0
# 40 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
                          );

  callbackcfgptr = 
# 42 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c" 3 4
                  ((void *)0)
# 42 "utExecutionAndResults/utUnderTest/test/test_validrawmidrange.c"
                      ;
