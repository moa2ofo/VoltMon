# 0 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c"
...
# 2 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 2
...
# 3 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 2
# 1 "utExecutionAndResults/utUnderTest/src/VoltMon_cfg.h" 1
# 4 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 2
# 1 "utExecutionAndResults/utUnderTest/src/VoltMon_priv.h" 1
# 5 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax/mock_VoltMon_cfg.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax/mock_VoltMon_cfg.h" 2
...
# 50 "utExecutionAndResults/utUnderTest/build/test/mocks/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax/mock_VoltMon_cfg.h"
#pragma GCC diagnostic pop
# 6 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax/mock_VoltMon_priv.h" 1
# 11 "utExecutionAndResults/utUnderTest/build/test/mocks/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax/mock_VoltMon_priv.h"
#pragma GCC diagnostic push
...
#pragma GCC diagnostic pop
# 7 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 2
...
# 16 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 3 4
                       0
# 16 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c"
                            );
  VoltMon_SetOvActive_b(
# 17 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 3 4
                       0
# 17 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c"
                            );
}
...
# 30 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c" 3 4
 ((void *)0)
# 30 "utExecutionAndResults/utUnderTest/test/test_returns_error_and_sets_err_and_inval_flags_if_rawAdc_greater_than_rawMax.c"
 ), (UNITY_UINT)(30), UNITY_DISPLAY_STYLE_UINT8);
  uint32_t status = VoltMon_GetStatusFlg_u32();
  do { if (((0u) != ((status & (0x00000002u))))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((32))); } } while (0);
  do { if (((0u) != ((status & (0x00000010u))))) { } else { UnityFail( ((" Expected Not-Equal")), (UNITY_UINT)((33))); } } while (0);
}
