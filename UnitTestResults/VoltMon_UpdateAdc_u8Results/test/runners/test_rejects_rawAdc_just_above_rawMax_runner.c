...
int main(void)
{
  UnityBegin("test_rejects_rawAdc_just_above_rawMax.c");
  run_test(test_VoltMon_UpdateAdc_u8_rejects_rawAdc_just_above_rawMax, "test_VoltMon_UpdateAdc_u8_rejects_rawAdc_just_above_rawMax", 24);
