...
int main(void)
{
  UnityBegin("test_accepts_rawAdc_just_below_rawMax.c");
  run_test(test_VoltMon_UpdateAdc_u8_accepts_rawAdc_just_below_rawMax, "test_VoltMon_UpdateAdc_u8_accepts_rawAdc_just_below_rawMax", 24);
