...
int main(void)
{
  UnityBegin("test_accepts_rawAdc_equal_to_rawMax.c");
  run_test(test_VoltMon_UpdateAdc_u8_accepts_rawAdc_equal_to_rawMax, "test_VoltMon_UpdateAdc_u8_accepts_rawAdc_equal_to_rawMax", 24);
